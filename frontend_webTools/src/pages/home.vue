    ...
    <div class="gdgg_xjbb_page-margin">
      <el-row type="flex" :gutter="80">
        <el-col :span="4">
          <a @click="$router.push('financeReport')">
            <div class="gdgg_xjbb_modular">
              <img class="gdgg_xjbb_icon" src="../assets/images/report.png" alt>
            </div>
        ...
        <el-col :span="4">
          <a>
            <div class="gdgg_xjbb_modular">
              <img class="gdgg_xjbb_icon" src="../assets/images/business-and-finance.png" alt>
            </div>
        ...
        <el-col :span="4">
          <a>
            <div class="gdgg_xjbb_modular">
              <img class="gdgg_xjbb_icon" src="../assets/images/skill.png" alt>
            </div>
        ...
        <el-col :span="4">
          <a>
            <div class="gdgg_xjbb_modular">
              <img class="gdgg_xjbb_icon" src="../assets/images/library.png" alt>
            </div>
